...
| [Insert](#insert-rules)|<code>* insert {RuleSet}<br/>* insert {RuleSet}({parameter1}<span class="optional">, {parameter2}, ...</span>)<br/>* &lt;element&gt; insert {RuleSet}<span class="optional">({parameter1}, {parameter2}, ...)</span></code> |
